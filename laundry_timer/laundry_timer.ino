...
void publishNews(String person) {
  if (person == user1) {
    publishSuccess = Particle.publish("pingUser1");
  }
  if (person == user2) {
    publishSuccess = Particle.publish("pingUser2");
  }
  if (publishSuccess) {
